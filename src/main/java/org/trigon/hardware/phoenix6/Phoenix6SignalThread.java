...
/**
 * Provides an interface for asynchronously reading high-frequency measurements to a set of queues for Phoenix 6. Used for getting values from status signals.
 */
