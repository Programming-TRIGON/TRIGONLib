package org.trigon.hardware.phoenix6.pigeon2.io;
...
import org.trigon.hardware.phoenix6.pigeon2.Pigeon2IO;
import org.trigon.hardware.simulation.GyroSimulation;
...
public class SimulationPigeon2IO extends Pigeon2IO {
    ...
    public void updateGyro() {
        if (yawVelocitySupplier == null)
            return;
        gyroSimulation.update(yawVelocitySupplier.getAsDouble(), RobotHardwareStats.getPeriodicTimeSeconds());
